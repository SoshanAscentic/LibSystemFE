...
import { MemberFilters } from '../../services/api/types';
import { useDebounce } from '../ui/useDebounce';

export const useMembersSearch = (initialFilters?: MemberFilters) => {
  ...
  const searchResults = useQuery({
    queryKey: ['members', 'search', debouncedQuery, filters],
    queryFn: () => membersApi.search(debouncedQuery, filters),
